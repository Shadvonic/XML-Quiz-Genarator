...
function updatePassingQuestions() {
  ...
  if (scoreInput.value.trim() !== "") {
    const totalQuestions = numQuestions; // Use the global variable numQuestions here
    const passingQuestions = Math.ceil(totalQuestions * (parseInt(scoreInput.value) / 100));
...
function updateScore() {
  ...
  if (passingQuestionsInput.value.trim() !== "") {
    const totalQuestions = numQuestions; // Use the global variable numQuestions here
    const score = (parseInt(passingQuestionsInput.value) / totalQuestions) * 100;
